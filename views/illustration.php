    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="inner_banner service_inner inner_service_pg">
                    <h1>Let 2D and 3D</h1>
                    <h1>Illustration tell your</h1>
                    <h1>story to the world</h1>                    
                </div>  
        ...
        <div class="row mt-5">
            ...
            <div class="simple_para">
                <p>Nothing goes unnoticed. Let your designs speak your truth. At Maxis Technologies, we have an ever-ready team of creative minds to turn your ideas into visually appealing stories.</p>
            </div>
            <div class="inner_points_servcies">
                    <ul>
                        <li>Innovative designs that are attention-grabbing</li>
                        <li>2D and 3D illustrations that are designed professionally</li>
                        <li>High-quality outputs that set you apart from the competitors</li>
                    </ul>
                </div>    
            </div>           
        </div>   
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="logo_inner_page">
                    <h1 class="checking">We Are Proud of Our Work</h1>
                    <p class="checking2">Check out some of our breathtaking designs for our valuable customers.</p>
                </div>
                <div class="design_logo">
                    <ul>
                        <li><img src="assets/images/illust_1.png" alt=""></li>
                        <li><img src="assets/images/illust_2.png" alt=""></li>
                        <li><img src="assets/images/illust_3.png" alt=""></li>
                        <li><img src="assets/images/illust_4.png" alt=""></li>
                        <li><img src="assets/images/illust_5.png" alt=""></li>
                        <li><img src="assets/images/illust_6.png" alt=""></li>
                        <li><img src="assets/images/illust_7.png" alt=""></li>
                        <li><img src="assets/images/illust_8.png" alt=""></li>
                        <li><img src="assets/images/illust_9.png" alt=""></li>
                    </ul>
                </div>
            </div>
        </div>
